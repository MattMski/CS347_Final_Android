...
public class SocialStudiesActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.socialstudies_layout, null, false);
        drawer.addView(contentView, 0);
        navigationView.setCheckedItem(R.id.nav_socialstudies);
